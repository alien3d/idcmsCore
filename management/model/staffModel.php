...
class staffModel extends validationClass
{
    ...
    function execute ()
    {
        ...
        if (isset($_POST['departmentId'])) {
            ...
            $this->strict($_POST['departmentId'], 'numeric'));
        }
        ...
        if (isset($_POST['staffPassword'])) {
            $this->setStaffPassword(
            $this->strict($_POST['staffPassword'], 'password'));
        }
    ...
    public function setStaffId ($value, $key, $type)
    {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                array("success" => false, 
                "message" => "Cannot Identifiy Type String Or Array:setStaffId ?"));
                exit();
            }
    }
    /**
    ...
    public function getStaffId ($key = NULL, $type = NULL)
    {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                array("success" => false, 
                "message" => "Cannot Identifiy Type String Or Array:getStaffId ?"));
                exit();
            }
    }
    /**
