Ext.onReady(function() {
    ...
    var businessPartnerCategoryFilters = new Ext.ux.grid.GridFilters({
        encode: false,
        local: false,
        filters: [ {
            type: 'list',
            ...
            type: 'string',
            dataIndex: 'businessPartnerCategoryDesc',
            column: 'businessPartnerCategoryDesc',
            table: 'businessPartnerCategory',
			database :'iCommon'
        },
        {
    ...
    var businessPartnerCategoryColumnModel = [new Ext.grid.RowNumberer(), {
        dataIndex: 'businessPartnerCategoryCode',
        header: businessPartnerCategoryCodeLabel,
        sortable: true,
        hidden: false,
        width : 200
    },{
        dataIndex: 'businessPartnerCategoryDesc',
        header: businessPartnerCategoryDescLabel,
        sortable: true,
        hidden: false,
        width : 200
    },
    ...
    var businessPartnerCategoryFlagArray = ['isDefault', 'isNew', 'isDraft', 'isUpdate', 'isDelete', 'isActive', 'isApproved', 'isReview', 'isPost'];
    var businessPartnerCategoryGrid = new Ext.grid.GridPanel({
        name: 'businessPartnerCategoryGrid',
        id: 'businessPartnerCategoryGrid',
        border: false,
        store: businessPartnerCategoryStore,
        autoHeight: false,
        height: 400,
        columns: businessPartnerCategoryColumnModel,
        plugins: [businessPartnerCategoryFilters],
        selModel: new Ext.grid.RowSelectionModel({
            singleSelect: true
        }),
        viewConfig: {
        ...
        listeners: {
            'rowclick': function(object, rowIndex, e) {
                var record = businessPartnerCategoryStore.getAt(rowIndex);
                ...
                formPanel.form.load({
                    ...
                    params: {
                        method: 'read',
                        mode: 'update',
                        businessPartnerCategoryId: record.data.businessPartnerCategoryId,
                        leafId: leafId,
                        isAdmin: isAdmin
                    },
                    success: function(form, action) {
                        Ext.getCmp('businessPartnerCategoryDescTemp').setValue(record.data.businessPartnerCategoryDesc);
        ...
        tbar: {
            items: [{
                ...
                listeners: {
                    'click': function(button,e) {
                        businessPartnerCategoryStore.each(function(record,fn,scope) {
                            for (var access in businessPartnerCategoryFlagArray) {
                                record.set(businessPartnerCategoryFlagArray[access], true);
                            }
                        });
                    }
                }
            },
            {
                ...
                listeners: {
                    'click': function(button,e) {
                        businessPartnerCategoryStore.each(function(record,fn,scope) {
                            for (var access in businessPartnerCategoryFlagArray) {
                                record.set(businessPartnerCategoryFlagArray[access], false);
                            }
                        });
                    }
                }
            },
            {
                ...
                listeners: {
                    'click': function(button,e) {
                        var url = '../controller/businessPartnerCategoryController.php?';
                        var sub_url = '';
                        var modified = businessPartnerCategoryStore.getModifiedRecords();
                        for (var i = 0; i < modified.length; i++) {
                            var dataChanges = modified[i].getChanges();
                            sub_url = sub_url + '&businessPartnerCategoryId[]=' + modified[i].get('businessPartnerCategoryId');
                            if (isAdmin == 1) {
                        ...
                        Ext.Ajax.request({
                            ...
                            success: function(response, options) {
                                ...
                                if (jsonResponse.success == true) {
                                    ...
                                    businessPartnerCategoryStore.reload();
    ...
    var gridPanel = new Ext.Panel({
        ...
        items: [businessPartnerCategoryGrid]
    });
     // form entry
    var businessPartnerCategoryCode = new Ext.form.TextField({
        labelAlign: 'left',
        fieldLabel: familyCodeLabel + '<span style=\'color: red;\'>*</span>',
        hiddenName: 'businessPartnerCategoryCode',
        name: 'businessPartnerCategoryCode',
        id: 'businessPartnerCategoryCode',
        allowBlank: false,
    ...
    var businessPartnerCategoryDesc = new Ext.form.TextField({
        labelAlign: 'left',
        fieldLabel: businessPartnerCategoryDescLabel + '<span style=\'color: red;\'>*</span>',
        hiddenName: 'businessPartnerCategoryDesc',
        name: 'businessPartnerCategoryDesc',
        id: 'businessPartnerCategoryDesc',
        allowBlank: false,
        blankText: blankTextLabel,
        style: {
            textTransform: 'uppercase'
    ...
    var businessPartnerCategoryCodeTemp = new Ext.form.Hidden({
        name: 'businessPartnerCategoryCodeTemp',
        id: 'businessPartnerCategoryCodeTemp'
    });
    var checkDuplicateCode = new Ext.Button ({
    	...
    	listeners: {
            'click': function(button,e) {
                if (Ext.getCmp('businessPartnerCategoryCode').getValue().length > 0) {
                    Ext.Ajax.request({
                        ...
                        params: {
                            method: 'duplicate',
                            leafId: leafId,
                            businessPartnerCategoryCode	: Ext.getCmp('businessPartnerCategoryCode').getValue()
                        },
                        success: function(response, options) {
                            jsonResponse = Ext.decode(response.responseText);
                            if (jsonResponse.success == true) {
                                if (jsonResponse.total > 0) {
                                    if (Ext.getCmp('businessPartnerCategoryCodeTemp').getValue() != Ext.getCmp('businessPartnerCategoryCode').getValue()) {
                                        duplicate = 1;
                                        duplicateMessageLabel = duplicateMessageLabel + Ext.util.Format.uppercase(Ext.getCmp('businessPartnerCategoryCode').getValue()) + ':' + +Ext.util.Format.uppercase(jsonResponse.religionDesc);
                                        Ext.MessageBox.alert(systemErrorLabel, duplicateMessageLabel);
                                        Ext.getCmp('businessPartnerCategoryCode').setValue('');
                                    } else {
                                    	Ext.MessageBox.alert(systemErrorLabel, jsonResponse.message);
                                    }
                                }
    ...
    var businessPartnerCategoryId = new Ext.form.Hidden({
        name: 'businessPartnerCategoryId',
    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        items: [{
            xtype: 'fieldset',
            title: 'Form Entry',
            items: [businessPartnerCategoryId,{
				xtype:'compositefield',
				items:[businessPartnerCategoryCode,checkDuplicateCode]
}, businessPartnerCategoryDesc,businessPartnerCategoryCodeTemp]
        },
        {
            xtype: 'fieldset',
        ...
        },
        {
            ...
            iconCls: 'new',
            handler: function() {
                var id = Ext.getCmp('businessPartnerCategoryId').getValue();
                var method = 'create';
                formPanel.getForm().submit({
                    ...
                    success: function(form, action) {
                        if (action.result.success == true) {
                            ...
                            Ext.getCmp('businessPartnerCategoryId').setValue(action.result.businessPartnerCategoryId);
                        } else {
                            Ext.MessageBox.alert(systemErrorLabel, action.result.message);
                        }
                    },
                    ...
                    fn: function(response) {
                        if ('yes' == response) {
                            Ext.Ajax.request({
                                ...
                                params: {
                                    method: 'delete',
                                    businessPartnerCategoryId: Ext.getCmp('businessPartnerCategoryId').getValue(),
                                    leafId: leafId,
                                    isAdmin: isAdmin
                                },
                                success: function(response, options) {
                        ...
                        success: function(response, options) {
                            ...
                            if (jsonResponse.success == true) {
                                ...
                                formPanel.form.load({
                                    ...
                                    params: {
                                        method: 'read',
                                        businessPartnerCategoryId: Ext.getCmp('firstRecord').getValue(),
                                        leafId: leafId,
                                        isAdmin: isAdmin
                                    },
                                    success: function(form, action) {
            ...
            handler: function() {
                ...
                if (Ext.getCmp('firstRecord').getValue() >= 1) {
                    formPanel.form.load({
                        ...
                        params: {
                            method: 'read',
                            businessPartnerCategoryId: Ext.getCmp('previousRecord').getValue(),
                            leafId: leafId,
                            isAdmin: isAdmin
                        },
                        success: function(form, action) {
            ...
            handler: function() {
                ...
                if (Ext.getCmp('nextRecord').getValue() <= Ext.getCmp('lastRecord').getValue()) {
                    formPanel.form.load({
                        ...
                        params: {
                            method: 'read',
                            businessPartnerCategoryId: Ext.getCmp('nextRecord').getValue(),
                            leafId: leafId,
                            isAdmin: isAdmin
                        },
                        success: function(form, action) {
        ...
        },
        {
            ...
            handler: function() {
                        ...
                        success: function(response, options) {
                            ...
                            if (jsonResponse.success == true) {
                                ...
                                formPanel.form.load({
                                    ...
                                    params: {
                                        method: 'read',
                                        businessPartnerCategoryId: Ext.getCmp('lastRecord').getValue(),
                                        leafId: leafId,
                                        isAdmin: isAdmin
                                    },
                                    success: function(form, action) {
                ...
                if (Ext.getCmp('businessPartnerCategoryId').getValue() <= Ext.getCmp('lastRecord').getValue()) {
                    formPanel.form.load({
                        url: '../controller/businessPartnerCategoryController.php',
                        method: 'POST',
                        waitTitle: systemLabel,
