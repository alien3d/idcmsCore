...
class Security extends ConfigClass
{
    ...
    function execute ()
    {
        ...
        $this->q->connect($this->getConnection(), 
        $this->getUsername(), $this->getDatabase(), $this->getPassword());
    ...
    public function group ()
    {
        ...
        if ($total > 0) {
            ...
            echo json_encode(
            array('success' => false, 'total' => $total, 'group' => $items, 
    ...
    public function department ()
    {
        ...
        if ($total > 0) {
            ...
            echo json_encode(
            array('success' => false, 'total' => 0, 'message' => 'Empty Record'));
            exit();
        }
        if ($total == 1) {
            $jsonEncode = json_encode(
