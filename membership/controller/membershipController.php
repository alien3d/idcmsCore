        ...
        if ($this->getVendor() == self::MYSQL) {
			...
			VALUES
					(
						...
						'" . $this->model->getMembershipMobile() . "',
    ...
    public function read() {
        ...
        if ($this->getVendor() == self::MYSQL) {
			...
			SELECT		MEMBERSHIP.MEMBERSHIPID   		 	AS 	\"membershipId\",
						...
						MEMBERSHIP.MEMBERSHIPMOBILE				AS 	\"membershipMobile\",
        ...
        if ($total == 0) {
            ...
            if ($this->getVendor() == self::MYSQL) {
				...
				SET 		`membershipSalary`			=	'" . $this->model->getMembershipSalary() . "',
							...
							`membershipMobile`				=	'" . $this->model->getMembershipMobile() . "',
