...
class InventoryTransactionsClass extends ConfigClass {
	...
	function duplicate() {
		...
		if ($total > 0) {
			...
			echo json_encode(array("success" => true, "total" => $total, "message" => $this->systemString->getDuplicateMessage(), "inventoryTransactionsDesc" => $row ['inventoryTransactionsDesc']));
			exit();
		} else {
...
if (isset($_POST ['method'])) {
	...
	if (isset($_POST ['databaseRequest'])) {
		$inventoryTransactionsObject->setDatabaseRequest($_POST ['databaseRequest']);
	}
	/*
	 *  Paging
	 */
	...
	if (isset($_POST ['character'])) {
		$inventoryTransactionsObject->setCharacterQuery($_POST['character']);
	}
	if (isset($_POST ['dateRangeStart'])) {
		$inventoryTransactionsObject->setDateRangeStartQuery($_POST['dateRangeStart']);
	}
	if (isset($_POST ['dateRangeEnd'])) {
		$inventoryTransactionsObject->setDateRangeEndQuery($_POST['dateRangeEnd']);
	}
	if (isset($_POST ['dateRangeType'])) {
		$inventoryTransactionsObject->setDateRangeTypeQuery($_POST['dateRangeType']);
	}
	/*
	 * Ordering
	 */
...
if (isset($_GET ['method'])) {
	...
	if (isset($_GET ['databaseRequest'])) {
		$inventoryTransactionsObject->setDatabaseRequest($_GET ['databaseRequest']);
	}
	/*
	 *  Load the dynamic value
	 */
