 ...
 * @author hafizan
 * @package shippers
 * @subpackage shippersv1,v2,v3,v4,v5
...
class ShippersClass extends ConfigClass {
	...
	public function create() {
		...
		$this->q->commit();
		echo json_encode(array("success" => true, "message" => "Record Created", "shippersId" => $shippersId));
		exit();
	}
	...
	function duplicate() {
		...
		if ($total > 0) {
			...
			echo json_encode(array("success" => true, "total" => $total, "message" => "Duplicate Record", "shippersDesc" => $row ['shippersDesc']));
			exit();
		} else {
