 ...
 * @author hafizan
 * @package orders
 * @subpackage ordersv1,v2,v3,v4,v5
...
class OrdersClass extends ConfigClass {
	...
	public function create() {
		...
		$this->q->commit();
		echo json_encode(array("success" => true, "message" => "Record Created", "ordersId" => $ordersId));
		exit();
	}
	...
	function duplicate() {
		...
		if ($total > 0) {
			...
			echo json_encode(array("success" => true, "total" => $total, "message" => "Duplicate Record", "ordersDesc" => $row ['ordersDesc']));
			exit();
		} else {
