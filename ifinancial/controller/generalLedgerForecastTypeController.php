...
class ForecastTypeClass extends ConfigClass {
	...
	public function create() {
		...
		if ($this->getVendor() == self::MYSQL) {
			...
			$sql = "
			INSERT INTO	GENERALLEDGERFORECASTTYPE
					(
	...
	public function read() {
		...
		if ($this->getVendor() == self::MYSQL) {
			...
			SELECT		GENERALLEDGERFORECASTTYPE.GENERALLEDGERFORECASTTYPEID   		 	AS 	\"forecastTypeId\",
						...
						GENERALLEDGERFORECASTTYPE.ISUPDATE     			AS	\"isUpdate\",
						GENERALLEDGERFORECASTTYPE.ISDELETE	  			AS	\"isDelete\",
						GENERALLEDGERFORECASTTYPE.ISACTIVE	  			AS	\"isActive\",
						GENERALLEDGERFORECASTTYPE.ISAPPROVED   			AS	\"isApproved\",
						GENERALLEDGERFORECASTTYPE.ISREVIEW	  			AS	\"isReview\",
						GENERALLEDGERFORECASTTYPE.ISPOST  	  			AS	\"isPost\",
						GENERALLEDGERFORECASTTYPE.EXECUTEBY    			AS	\"executeBy\",
						GENERALLEDGERFORECASTTYPE.EXECUTETIME  			AS	\"executeTime\",
...
if (isset($_POST ['method'])) {
	...
	if (isset($_POST ['dateRangeStart'])) {
		$forecastSegmentObject->setDateRangeStartQuery($_POST['dateRangeStart']);
	}
	if (isset($_POST ['dateRangeEnd'])) {
		$forecastSegmentObject->setDateRangeEndQuery($_POST['dateRangeEnd']);
	}
	if (isset($_POST ['dateRangeType'])) {
		$forecastSegmentObject->setDateRangeTypeQuery($_POST['dateRangeType']);
	}
	/*
	 * Ordering
	 */
