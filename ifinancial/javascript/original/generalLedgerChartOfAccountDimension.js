Ext.onReady(function () {
	...
	var staffByProxy = new Ext.data.HttpProxy({
			url : '../controller/generalLedgerChartOfAccountDimensionController.php?',
			method : 'GET',
	...
	// end chart of account request
	// end additional Proxy ,Reader,Store,Filter,Grid
	// start application Proxy ,Reader,Store,Filter,Grid
	var generalLedgerChartOfAccountDimensionProxy = new Ext.data.HttpProxy({
			url : '../controller/generalLedgerChartOfAccountDimensionController.php',
			method : 'POST',
			success : function (response, options) {
				jsonResponse = Ext.decode(response.responseText);
	...
	var generalLedgerChartOfAccountDimensionReader = new Ext.data.JsonReader({
			totalProperty : 'total',
			successProperty : 'success',
			messageProperty : 'message',
			idProperty : 'generalLedgerChartOfAccountDimensionId'
		});
	var generalLedgerChartOfAccountDimensionStore = new Ext.data.JsonStore({
			proxy : generalLedgerChartOfAccountDimensionProxy,
			reader : generalLedgerChartOfAccountDimensionReader,
			autoLoad : true,
			autoDestroy : true,
			pruneModifiedRecords : true,
			baseParams : {
			...
			fields : [{
					...
					name : 'generalLedgerChartOfAccountDimensionTitle',
					type : 'string'
				}, {
					name : 'generalLedgerChartOfAccountDimensionDesc',
					type : 'string'
				}, {
					name : 'generalLedgerChartAccountIdStart',
					type : 'string'
				}, {
					name : 'generalLedgerChartAccountIdEnd',
					type : 'string'
				}, {
					name : 'isDefault',
					type : 'boolean'
	...
	var generalLedgerChartOfAccountDimensionFilters = new Ext.ux.grid.GridFilters({
			encode : false,
			local : false,
			filters : [{
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountDimensionTitle',
					column : 'generalLedgerChartOfAccountDimensionTitle',
					table : 'generalLedgerChartOfAccountDimension',
					database : 'iFinancial'
				}, {
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountDimensionDesc',
					column : 'generalLedgerChartOfAccountDimensionDesc',
					table : 'generalLedgerChartOfAccountDimension',
					database : 'iFinancial'
				},{
					type : 'list',
	...
	var generalLedgerChartOfAccountDimensionColumnModel = [new Ext.grid.RowNumberer(), {
			...
			dataIndex : 'generalLedgerChartOfAccountDimensionTitle',
			header : generalLedgerChartOfAccountDimensionTitleLabel,
			sortable : true,
			hidden : false,
			width : 50
		}, {
			dataIndex : 'generalLedgerChartOfAccountDimensionDesc',
			header : generalLedgerChartOfAccountDimensionDescLabel,
			sortable : true,
			hidden : false,
			width : 50
		}, {
	...
	var generalLedgerChartOfAccountDimensionFlagArray = ['isDefault', 'isNew', 'isDraft', 'isUpdate', 'isDelete', 'isActive', 'isApproved', 'isReview', 'isPost'];
	var generalLedgerChartOfAccountDimensionGrid = new Ext.grid.GridPanel({
			name : 'generalLedgerChartOfAccountDimensionGrid',
			id : 'generalLedgerChartOfAccountDimensionGrid',
			border : false,
			store : generalLedgerChartOfAccountDimensionStore,
			autoHeight : false,
			height : 400,
			columns : generalLedgerChartOfAccountDimensionColumnModel,
			plugins : [generalLedgerChartOfAccountDimensionFilters],
			selModel : new Ext.grid.RowSelectionModel({
				singleSelect : true
			}),
			viewConfig : {
			...
			listeners : {
				'rowclick' : function (object, rowIndex, e) {
					var record = generalLedgerChartOfAccountDimensionStore.getAt(rowIndex);
					...
					formPanel.form.load({
						...
						params : {
							method : 'read',
							mode : 'update',
							generalLedgerChartOfAccountDimensionId : record.data.generalLedgerChartOfAccountDimensionId,
							leafId : leafId,
							isAdmin : isAdmin
						},
						success : function (form, action) {
							Ext.getCmp('generalLedgerChartOfAccountDimensionCodeTemp').setValue(record.data.generalLedgerChartOfAccountDimensionDesc);
				...
				items : [{
						...
						listeners : {
							'click' : function (button, e) {
								generalLedgerChartOfAccountDimensionStore.each(function (record, fn, scope) {
									for (var access in generalLedgerChartOfAccountDimensionFlagArray) {
										record.set(generalLedgerChartOfAccountDimensionFlagArray[access], true);
									}
								});
							}
						}
						...
						listeners : {
							'click' : function (button, e) {
								generalLedgerChartOfAccountDimensionStore.each(function (record, fn, scope) {
									for (var access in generalLedgerChartOfAccountDimensionFlagArray) {
										record.set(generalLedgerChartOfAccountDimensionFlagArray[access], false);
									}
								});
							}
						}
						...
						listeners : {
							'click' : function (button, e) {
								var url = '../controller/generalLedgerChartOfAccountDimensionController.php?';
								var sub_url = '';
								var modified = generalLedgerChartOfAccountDimensionStore.getModifiedRecords();
								for (var i = 0; i < modified.length; i++) {
									var dataChanges = modified[i].getChanges();
									sub_url = sub_url + '&generalLedgerChartOfAccountDimensionId[]=' + modified[i].get('generalLedgerChartOfAccountDimensionId');
									if (isAdmin == 1) {
								...
								Ext.Ajax.request({
									...
									success : function (response, options) {
										...
										if (jsonResponse.success == true) {
											...
											generalLedgerChartOfAccountDimensionStore.reload();
	...
	var gridPanel = new Ext.Panel({
			...
			items : [generalLedgerChartOfAccountDimensionGrid]
		});
	// form entry
	var generalLedgerChartOfAccountDimensionTitle = new Ext.form.TextField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountDimensionTitleLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerDDesc',
			name : 'generalLedgerChartOfAccountDimensionDesc',
			id : 'generalLedgerChartOfAccountDimensionDesc',
			allowBlank : false,
	...
	var generalLedgerChartOfAccountDimensionDesc = new Ext.form.TextField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountDimensionDescLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerChartOfAccountDimensionDesc',
			name : 'generalLedgerChartOfAccountDimensionDesc',
			id : 'generalLedgerChartOfAccountDimensionDesc',
			allowBlank : false,
			blankText : blankTextLabel,
	...
	var generalLedgerChartOfAccountIdStart = new Ext.ux.form.ComboBoxMatch({
        ...
        hiddenId: 'g generalLedgerChartOfAccountIdStart_fake',
        id: ' generalLedgerChartOfAccountIdStart',
	...
	var generalLedgerChartOfAccountDimensionId = new Ext.form.Hidden({
			name : 'generalLedgerChartOfAccountDimensionId',
			id : 'generalLedgerChartOfAccountDimensionId'
		}); // end form entry
	...
	var formPanel = new Ext.form.FormPanel({
			...
			items : [{
					xtype : 'fieldset',
					title : 'Form Entry',
					items : [generalLedgerChartOfAccountDimensionId,
			...
			buttons : [{
					...
					iconCls : 'new',
					handler : function () {
						var id = Ext.getCmp('generalLedgerChartOfAccountDimensionId').getValue();
						var method = 'create';
						formPanel.getForm().submit({
							...
							success : function (form, action) {
								if (action.result.success == true) {
									...
									Ext.getCmp('generalLedgerChartOfAccountDimensionId').setValue(action.result.generalLedgerChartOfAccountDimensionId);
								} else {
									Ext.MessageBox.alert(systemErrorLabel, action.result.message);
								}
							},
							...
							fn : function (response) {
								if ('yes' == response) {
									Ext.Ajax.request({
										...
										params : {
											method : 'delete',
											generalLedgerChartOfAccountDimensionId : Ext.getCmp('generalLedgerChartOfAccountDimensionId').getValue(),
											leafId : leafId,
											isAdmin : isAdmin
										},
										success : function (response, options) {
								...
								success : function (response, options) {
									...
									if (jsonResponse.success == true) {
										...
										formPanel.form.load({
											...
											params : {
												method : 'read',
												generalLedgerChartOfAccountDimensionId : Ext.getCmp('firstRecord').getValue(),
												leafId : leafId,
												isAdmin : isAdmin
											},
											success : function (form, action) {
					...
					handler : function () {
						...
						if (Ext.getCmp('firstRecord').getValue() >= 1) {
							formPanel.form.load({
								...
								params : {
									method : 'read',
									generalLedgerChartOfAccountDimensionId : Ext.getCmp('previousRecord').getValue(),
									leafId : leafId,
									isAdmin : isAdmin
								},
								success : function (form, action) {
					...
					handler : function () {
						...
						if (Ext.getCmp('nextRecord').getValue() <= Ext.getCmp('lastRecord').getValue()) {
							formPanel.form.load({
								...
								params : {
									method : 'read',
									generalLedgerChartOfAccountDimensionId : Ext.getCmp('nextRecord').getValue(),
									leafId : leafId,
									isAdmin : isAdmin
								},
								success : function (form, action) {
					...
					handler : function () {
								...
								success : function (response, options) {
									...
									if (jsonResponse.success == true) {
										...
										formPanel.form.load({
											...
											params : {
												method : 'read',
												generalLedgerChartOfAccountDimensionId : Ext.getCmp('lastRecord').getValue(),
												leafId : leafId,
												isAdmin : isAdmin
											},
											success : function (form, action) {
						...
						if (Ext.getCmp('generalLedgerChartOfAccountDimensionId').getValue() <= Ext.getCmp('lastRecord').getValue()) {
							formPanel.form.load({
								url : '../controller/generalLedgerChartOfAccountDimensionController.php',
								method : 'POST',
								waitTitle : systemLabel,
