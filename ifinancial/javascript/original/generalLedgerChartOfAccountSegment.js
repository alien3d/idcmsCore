Ext.onReady(function () {
	...
	var generalLedgerChartOfAccountSegmentProxy = new Ext.data.HttpProxy({
			url : '../controller/generalLedgerChartOfAccountSegmentController.php',
			method : 'POST',
			success : function (response, options) {
				jsonResponse = Ext.decode(response.responseText);
	...
	var generalLedgerChartOfAccountSegmentReader = new Ext.data.JsonReader({
			totalProperty : 'total',
			successProperty : 'success',
			messageProperty : 'message',
			idProperty : 'generalLedgerChartOfAccountSegmentId'
		});
	var generalLedgerChartOfAccountSegmentStore = new Ext.data.JsonStore({
			proxy : generalLedgerChartOfAccountSegmentProxy,
			reader : generalLedgerChartOfAccountSegmentReader,
			autoLoad : true,
			autoDestroy : true,
			pruneModifiedRecords : true,
			baseParams : {
			...
			fields : [{
					...
					name : 'generalLedgerChartOfAccountSegmentNo',
					type : 'string'
				}, {
					name : 'generalLedgerChartOfAccountSegmentLength',
					type : 'string'
				}, {
					name : 'generalLedgerChartOfAccountSegmentTitle',
					type : 'string'
				}, {
					name : 'generalLedgerChartOfAccountSegmentDesc',
					type : 'string'
				}, {
					name : 'isDefault',
					type : 'boolean'
	...
	var generalLedgerChartOfAccountSegmentFilters = new Ext.ux.grid.GridFilters({
			encode : false,
			local : false,
			filters : [{
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountSegmentNo',
					column : 'generalLedgerChartOfAccountSegmentNo',
					table : 'generalLedgerChartOfAccountSegment',
					database : 'iFinancial'
				}, {
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountSegmentLength',
					column : 'generalLedgerChartOfAccountSegmentLength',
					table : 'generalLedgerChartOfAccountSegment',
					database : 'iFinancial'
				}, {
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountSegmentTitle',
					column : 'generalLedgerChartOfAccountSegmentTitle',
					table : 'generalLedgerChartOfAccountSegment',
					database : 'iFinancial'
				}, {
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountSegmentDesc',
					column : 'generalLedgerChartOfAccountSegmentDesc',
					table : 'generalLedgerChartOfAccountSegment',
					database : 'iFinancial'
				}, {
					type : 'list',
	...
	var generalLedgerChartOfAccountSegmentColumnModel = [new Ext.grid.RowNumberer(), {
			dataIndex : 'generalLedgerChartOfAccountSegmentNo',
			header : generalLedgerChartOfAccountSegmentNoLabel,
			sortable : true,
			hidden : false,
			width : 50
		}, {
			dataIndex : 'generalLedgerChartOfAccountSegmentLength',
			header : generalLedgerChartOfAccountSegmentLengthLabel,
			sortable : true,
			hidden : false,
			width : 50
		}, {
			dataIndex : 'generalLedgerChartOfAccountSegmentTitle',
			header : generalLedgerChartOfAccountSegmentTitleLabel,
			sortable : true,
			hidden : false,
			width : 100
		}, {
			dataIndex : 'generalLedgerChartOfAccountSegmentDesc',
			header : generalLedgerChartOfAccountSegmentDescLabel,
			sortable : true,
			hidden : false,
			width : 100
		},
	...
	var generalLedgerChartOfAccountSegmentFlagArray = ['isDefault', 'isNew', 'isDraft', 'isUpdate', 'isDelete', 'isActive', 'isApproved', 'isReview', 'isPost'];
	var generalLedgerChartOfAccountSegmentGrid = new Ext.grid.GridPanel({
			name : 'generalLedgerChartOfAccountSegmentGrid',
			id : 'generalLedgerChartOfAccountSegmentGrid',
			border : false,
			store : generalLedgerChartOfAccountSegmentStore,
			autoHeight : false,
			height : 400,
			columns : generalLedgerChartOfAccountSegmentColumnModel,
			plugins : [generalLedgerChartOfAccountSegmentFilters],
			selModel : new Ext.grid.RowSelectionModel({
				singleSelect : true
			}),
			viewConfig : {
			...
			listeners : {
				'rowclick' : function (object, rowIndex, e) {
					var record = generalLedgerChartOfAccountSegmentStore.getAt(rowIndex);
					...
					formPanel.form.load({
						...
						params : {
							method : 'read',
							mode : 'update',
							generalLedgerChartOfAccountSegmentId : record.data.generalLedgerChartOfAccountSegmentId,
							leafId : leafId,
							isAdmin : isAdmin
						},
						success : function (form, action) {
							Ext.getCmp('generalLedgerChartOfAccountSegmentCodeTemp').setValue(record.data.generalLedgerChartOfAccountSegmentDesc);
				...
				items : [{
						...
						listeners : {
							'click' : function (button, e) {
								generalLedgerChartOfAccountSegmentStore.each(function (record, fn, scope) {
									for (var access in generalLedgerChartOfAccountSegmentFlagArray) {
										record.set(generalLedgerChartOfAccountSegmentFlagArray[access], true);
									}
								});
							}
						}
						...
						listeners : {
							'click' : function (button, e) {
								generalLedgerChartOfAccountSegmentStore.each(function (record, fn, scope) {
									for (var access in generalLedgerChartOfAccountSegmentFlagArray) {
										record.set(generalLedgerChartOfAccountSegmentFlagArray[access], false);
									}
								});
							}
						}
						...
						listeners : {
							'click' : function (button, e) {
								var url = '../controller/generalLedgerChartOfAccountSegmentController.php?';
								var sub_url = '';
								var modified = generalLedgerChartOfAccountSegmentStore.getModifiedRecords();
								for (var i = 0; i < modified.length; i++) {
									var dataChanges = modified[i].getChanges();
									sub_url = sub_url + '&generalLedgerChartOfAccountSegmentId[]=' + modified[i].get('generalLedgerChartOfAccountSegmentId');
									if (isAdmin == 1) {
	...
	var generalLedgerChartOfAccountSegmentNo 	 = new Ext.form.NumberField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountSegmentNoLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerChartOfAccountSegmentNo',
			name : 'generalLedgerChartOfAccountSegmentNo',
			id : 'generalLedgerChartOfAccountSegmentNo',
			allowBlank : false,
	...
	var generalLedgerChartOfAccountSegmentLength = new Ext.form.NumberField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountSegmentLengthLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerChartOfAccountSegmentLength',
			name : 'generalLedgerChartOfAccountSegmentLength',
			id : 'generalLedgerChartOfAccountSegmentLength',
			allowBlank : false,
			blankText : blankTextLabel,
			style : {
				textTransform : 'uppercase'
	...
	var generalLedgerChartOfAccountSegmentTitle 	 = new Ext.form.TextField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountSegmentTitleLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerChartOfAccountSegmentTitle',
			name : 'generalLedgerChartOfAccountSegmentTitle',
			id : 'generalLedgerChartOfAccountSegmentTitle',
			allowBlank : false,
			blankText : blankTextLabel,
			style : {
				textTransform : 'uppercase'
	...
	var generalLedgerChartOfAccountSegmentDesc = new Ext.form.TextField({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountSegmentDescLabel + '<span style=\'color: red;\'>*</span>',
			hiddenName : 'generalLedgerChartOfAccountSegmentDesc',
			name : 'generalLedgerChartOfAccountSegmentDesc',
			id : 'generalLedgerChartOfAccountSegmentDesc',
			allowBlank : false,
			blankText : blankTextLabel,
			style : {
				textTransform : 'uppercase'
	...
	var generalLedgerChartOfAccountSegmentId = new Ext.form.Hidden({
			name : 'generalLedgerChartOfAccountSegmentId',
			id : 'generalLedgerChartOfAccountSegmentId'
		}); // end form entry
	...
	var formPanel = new Ext.form.FormPanel({
			...
			items : [{
					xtype : 'fieldset',
					title : 'Form Entry',
					items : [generalLedgerChartOfAccountSegmentId,
			...
			buttons : [{
					...
					iconCls : 'new',
					handler : function () {
						var id = Ext.getCmp('generalLedgerChartOfAccountSegmentId').getValue();
						var method = 'create';
						formPanel.getForm().submit({
							...
							success : function (form, action) {
								if (action.result.success == true) {
									...
									Ext.getCmp('generalLedgerChartOfAccountSegmentId').setValue(action.result.generalLedgerChartOfAccountSegmentId);
								} else {
									Ext.MessageBox.alert(systemErrorLabel, action.result.message);
								}
							},
							...
							fn : function (response) {
								if ('yes' == response) {
									Ext.Ajax.request({
										...
										params : {
											method : 'delete',
											generalLedgerChartOfAccountSegmentId : Ext.getCmp('generalLedgerChartOfAccountSegmentId').getValue(),
											leafId : leafId,
											isAdmin : isAdmin
										},
										success : function (response, options) {
								...
								success : function (response, options) {
									...
									if (jsonResponse.success == true) {
										...
										formPanel.form.load({
											...
											params : {
												method : 'read',
												generalLedgerChartOfAccountSegmentId : Ext.getCmp('firstRecord').getValue(),
												leafId : leafId,
												isAdmin : isAdmin
											},
											success : function (form, action) {
					...
					handler : function () {
						...
						if (Ext.getCmp('firstRecord').getValue() >= 1) {
							formPanel.form.load({
								...
								params : {
									method : 'read',
									generalLedgerChartOfAccountSegmentId : Ext.getCmp('previousRecord').getValue(),
									leafId : leafId,
									isAdmin : isAdmin
								},
								success : function (form, action) {
					...
					handler : function () {
						...
						if (Ext.getCmp('nextRecord').getValue() <= Ext.getCmp('lastRecord').getValue()) {
							formPanel.form.load({
								...
								params : {
									method : 'read',
									generalLedgerChartOfAccountSegmentId : Ext.getCmp('nextRecord').getValue(),
									leafId : leafId,
									isAdmin : isAdmin
								},
								success : function (form, action) {
					...
					handler : function () {
								...
								success : function (response, options) {
									...
									if (jsonResponse.success == true) {
										...
										formPanel.form.load({
											...
											params : {
												method : 'read',
												generalLedgerChartOfAccountSegmentId : Ext.getCmp('lastRecord').getValue(),
												leafId : leafId,
												isAdmin : isAdmin
											},
											success : function (form, action) {
						...
						if (Ext.getCmp('generalLedgerChartOfAccountSegmentId').getValue() <= Ext.getCmp('lastRecord').getValue()) {
							formPanel.form.load({
								url : '../controller/generalLedgerChartOfAccountSegmentController.php',
								method : 'POST',
								waitTitle : systemLabel,
