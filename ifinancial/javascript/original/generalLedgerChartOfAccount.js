Ext.onReady(function () {
	...
	var generalLedgerChartOfAccountFilters = new Ext.ux.grid.GridFilters({
			...
			filters : [{
					...
					type : 'string',
					dataIndex : 'generalLedgerChartOfAccountReportType',
					column : 'generalLedgerChartOfAccountReportType',
					table : 'generalLedgerChartOfAccount',
					database : 'ifinancial'
				}, {
					type : 'boolean',
	...
	var generalLedgerChartOfAccountColumnModel = [new Ext.grid.RowNumberer(), {
			...
			dataIndex : 'generalLedgerChartOfAccountTitle',
			header : generalLedgerChartOfAccountTitleLabel,
			sortable : true,
			hidden : false
		}, {
			dataIndex : 'generalLedgerChartOfAccountDesc',
			...
			dataIndex : 'generalLedgerChartOfAccountNo',
			header : generalLedgerChartOfAccountNoLabel,
			sortable : true,
			hidden : false
		}, {
			dataIndex : 'generalLedgerChartOfAccountTypeId',
			header : generalLedgerChartOfAccountTypeIdLabel,
			sortable : true,
			hidden : false
		}, {
			dataIndex : 'generalLedgerChartOfAccountReportType',
			header : generalLedgerChartOfAccountReportTypeLabel,
			sortable : true,
			hidden : false
		},
		isDefaultGrid,
	...
	var generalLedgerChartOfAccountFlagArray = ['isDefault', 'isNew', 'isDraft', 'isUpdate', 'isDelete', 'isActive', 'isApproved', 'isReview', 'isPost','isConsolidation','isSeperated'];
	...
	var generalLedgerChartOfAccountReportType = new Ext.ux.form.ComboBoxMatch({
			labelAlign : 'left',
			fieldLabel : generalLedgerChartOfAccountReportTypeLabel,
			name : 'generalLedgerChartOfAccountReportType',
