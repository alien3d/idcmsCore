...
class DocumentCategoryModel extends ValidationClass
{
    ...
    function execute ()
    {
        ...
        if (isset($_POST['documentCategoryId'])) {
            $this->setDocumentCategoryId(
            $this->strict($_POST['documentCategoryId'], 'numeric'), 0, 'single');
        }
        if (isset($_POST['documentCategoryTitle'])) {
            $this->setDocumentCategoryTitle(
            $this->strict($_POST['documentCategoryTitle'], 'memo'));
        }
        if (isset($_POST['documentCategoryDesc'])) {
            $this->setDocumentCategoryDesc(
            $this->strict($_POST['documentCategoryDesc'], 'memo'));
        }
        if (isset($_POST['documentCategoryCode'])) {
            $this->setDocumentCategoryCode(
            $this->strict($_POST['documentCategoryCode'], 'string'));
        }
        if (isset($_POST['documentCategorySequence'])) {
            $this->setDocumentCategorySequence(
            $this->strict($_POST['documentCategorySequence'], 'numeric'));
        }
        if (isset($_POST['documentCategoryNote'])) {
            $this->setDocumentCategoryNote(
            $this->strict($_POST['documentCategoryNote'], 'memo'));
        }
        ...
        for ($i = 0; $i < $this->getTotal(); $i ++) {
            if (isset($_GET['documentCategoryId'])) {
                ...
                $this->strict($_GET['documentCategoryId'][$i], 'numeric'), $i, 
                'array');
            }
    ...
    public function setDocumentCategoryId ($value, $key, $type)
    {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                array("success" => false, 
                "message" => "Cannot Identifiy Type String Or Array:setDocumentCategoryId ?"));
                exit();
            }
    }
    /**
    ...
    public function getDocumentCategoryId ($key, $type)
    {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                array("success" => false, 
                "message" => "Cannot Identifiy Type String Or Array:getDocumentCategoryId ?"));
                exit();
            }
    }
    /**
