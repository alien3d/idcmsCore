...
App = function() {
    return {
        init: function() {
            ...
            this.eventStore.load(); // This is the app UI layout code.  All of the calendar views are subcomponents of
                ...
                },
                {
                    ...
                    },
                    {
                        ...
                        listeners: {
                            ...
                            'eventover': function(vw, rec, el) { //console.log('Entered evt rec='+rec.data.Title+', view='+ vw.id +', el='+el.id);
                            },
                            'eventout': function(vw, rec, el) { //console.log('Leaving evt rec='+rec.data.Title+', view='+ vw.id +', el='+el.id);
                            },
                            'eventadd': {
                                fn: function(cp, rec) {
                            ...
                            'eventupdate': {
                                fn: function(cp, rec) {
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        failure: function(response, options) { // critical bug extjs
                                            var jsonResponse = Ext.decode(response.responseText);
                                            Ext.MessageBox.alert(systemErrorLabel, jsonResponse.message);
                                        }
                                    });
                            ...
                            'eventcancel': {
                                fn: function(cp, rec) { // edit canceled
                                },
                                scope: this
                            },
                            'viewchange': {
                                fn: function(p, vw, dateInfo) {
                                    ...
                                    if (dateInfo !== null) { // will be null when switching to the event edit form so ignore
